  ...
  <div>
    ...
    <div class="content-container">
      <Row>
        ...
        :columns="userColumns"
        url="/sys/user/list" :pagination="false"
        :upDownMove="true"
    ...
    <roleResource ref="userResource"></roleResource>
...
<script>
  ...
  export default{
    name:'user',
    components:{vTable,userEdit,Button,roleResource},
    data(){
      return {
        userEditModel:false,
        userColumns:[
      ...
      addAction(){
        ...
        let resource = this.$refs.userResource.roleResourceList;
        request.post('/sys/user/saveResource',resource,{userId:id}).then(res=>{
