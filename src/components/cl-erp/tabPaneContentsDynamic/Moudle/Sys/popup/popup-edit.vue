             ...
             <Tabs>
                <TabPane label="弹窗列配置" name="name2">
                    ...
                    >
                      <template slot="head">
                        <tr>
                          <th class="ivu-table-column-center" v-for="(item,index) in popupInitData.page.sysPopupFieldFM.columns.edit" :key="index" :width="item.width">
                      ...
                      <template slot="body" slot-scope="{row,index,valueChangeAssign}">
                        <td class="ivu-table-column-center" v-for="(item,itemIndex) in popupInitData.page.sysPopupFieldFM.columns.edit" :key="itemIndex" :width="item.width">
