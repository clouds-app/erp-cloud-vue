    ...
    <div class="content-container" :style="{'height':tableHeight+'px'}">
      <Split :v-model="splitModel" mode="vertical">
        <div slot="top" class="demo-split-pane">
           <vTable :height="tableHeight / 2 " ref="master_list_table" :columns="columns" url="/sys/table/page" :pagination="true" @row-click="tableRowClick"></vTable>
        </div>
        <div slot="bottom" :style="{'padding-top':'6px'}">
            <Tabs>
              <TabPane label="表列信息" name="name1">
                <vTable :height="tableHeight / 2" ref="tableFieldRef" :table-data="tableFieldData" :columns="tableFieldColuns" :pagination="false"></vTable>
              </TabPane>
