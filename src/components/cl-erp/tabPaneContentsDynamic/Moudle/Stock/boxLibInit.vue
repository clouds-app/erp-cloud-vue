...
export default {
  ...
  components: {
    editForm: function(resolve) {
      //组件的异步加载
      require(["./edit/edit-boxLibInit"], resolve);
    },
    htmlTemplate,
    vTable
  },
  data() {
    return {
      ...
      functionParams: {
        formInitPreName:'stockboxlibinit',// 查询表格列头信息 前缀 例如:purchasesupplierArt Fm/itemFm/mdataFm
        requestBaseUrl: "/stock/boxLibInit",
        uniqueId: "biId"
      },
      // 查询参数 ,注意格式
      queryParamsDefault: [
  ...
  methods: {
    ...
    getItemDataById() {
      //debugger
      let url = `/stock/boxLibInit/item/list`;
      let data = {
