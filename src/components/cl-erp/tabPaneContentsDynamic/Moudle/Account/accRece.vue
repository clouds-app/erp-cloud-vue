      ...
      >
        ...
        <!-- <FormItem label="客户号" prop="custName">
          <popup
            ...
            :fill-model.sync="formGetBack"
            render-fields="custId,cusCode,custName,areaIds,bdDeAddr,addrDetail,bdSaleId,bdSaleCode,bdSaleName,followerId,followerCode,followerName"
  ...
  methods: {
     //批量生成应收对账单
        ...
        let params = {
          ...
          mode: this.formGetBack.mode?1:0, 
          custCodes:this.formGetBack.cusCode,
    ...
    //rowData.cusCode + " " + rowData.custName 一般对应
