      ...
      <Split :v-model="splitModel" mode="vertical">
        <div slot="top" class="demo-split-pane">
          <div ref="contextMenuTarget">
              ...
              :columns-url="functionParams.requestColBaseUrl + '/purLbFee'"
              url="/purchase/purLbFee/page"
              :pagination="true"
            ...
            <TabPane label="楞别加价明细" name="name1">
              <vTable
               ...
               :height="tableHeight / 2-37"
                ...
                :columns-url="functionParams.requestColBaseUrl + '/purLbFeeItemFm'"
                :pagination="false"
...
export default {
  ...
  components: {
    'editForm': function (resolve) { // 组件的异步加载
      require(['./edit/edit-purLbFee'], resolve)
    },
  ...
  data () {
    return {
      ...
      functionParams: {
        requestBaseUrl: '/purchase/purLbFee',
        uniqueId: 'id'
      },
      // 查询参数 ,注意格式
      queryParamsDefault: [
  ...
  methods: {
    ...
    getItemDataById () {
      // debugger
      let url = `/purchase/purLbFee/item/list`
      let data = {
        feeId: this.masterRowSelection.id
      }
      let _self = this
