        ...
        >
          <div class="edit-purPaperPoSlave">
            <Row style="margin-left:-50px">
              <Col span="4" >
                <FormItem label="" prop="inCusCode" >
                  <Input v-model="formDataInfo.master.inCusCode" maxlength="20" placeholder="请输入客户编号"></Input>
                </FormItem>
              </Col>
              ...
              <Col span="8">
                <Row>
                  ...
                  <Col span="12" style="width: 35%;">
                    <FormItem label="--" style="margin-left: -70px;">
                      <DatePicker
                        type="date"
                        format="yyyy-MM-dd"
              ...
              <Col span="2">
                <FormItem label style="margin-left: -100%;">
...
export default {
  ...
  methods: {
    ...
    // clicktable(){
    //   // debugger
    //   // let one = this.formDataInfo
    //   // let tow = this.WorkOrderNumber
    //   // let str = this.formDataInfo.productMDatas
    //   // let fiv = this.$refs['slave_edit-purPaperPo'].cloneData
    // },
    //搜索点击事件
    clickmaster(){
      //debugger
      ...
      let one = {
        ...
        inCusName:this.formDataInfo.master.inCusName,
        inCusCode:this.formDataInfo.master.inCusCode,
        workNo:"",
        bmArtId:"",
        workNo1:""
      }
      request.post(`/purchase/purPaperPo/spPaperMegerStockOrder1`,one).then(res=>{
        ...
        // console.log(this.formDataInfo.productMDatas)
        // console.log(res)
      })
    },
    ...
    getFormInitDataObj() {
      ...
      this.formDataInfo["master"] = {
        ...
        endDate:dayjs().format("2020-12-30"),
        ifAreaPrice:false,
      }
      this.formDataInfo["productMDatas"] = {
