export default {
  ...
  login: {
      title: '系统登录',
      loginIn: '登录',
      userCodeLabelTips: '请输入用户名',
      passwordLabelTips: '请输入密码',
      companyCodeLabelTips:'请输入单位编号',
      error_companyCodeIsNull:'请输入单位编号',
      error_userCodeIsNull:'请输入用户名',
      error_passwordIsNull:'请输入密码'
    }
}
