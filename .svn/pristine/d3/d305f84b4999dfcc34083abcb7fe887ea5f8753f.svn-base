          ...
          <Row>
            ...
            <Col span="6">
              <FormItem label="业务员">
                <Input
                  :disabled="true"
                  v-model="formDataInfo.master.workName"
                  maxlength="40"
                  placeholder="业务员"
                ></Input>
              </FormItem>
            ...
            <Col span="6">
              <FormItem label="发票编号" prop="icInvoiceNo">
                <Input
                  v-model="formDataInfo.master.icInvoiceNo"
                  maxlength="40"
                  placeholder="发票编号"
                ></Input>
              </FormItem>
            ...
            <Col span="6">
              <FormItem label="发票说明" prop="icRemark">
                <Input
                  v-model="formDataInfo.master.icRemark"
                  maxlength="80"
                  placeholder="发票说明"
                ></Input>
              </FormItem>
            ...
            <Col span="6">
              <FormItem label="总金额" prop="icMoney">
                <InputNumber
                  ...
                  placeholder="总金额"
                  :min="0"
                  v-model="formDataInfo.master.icMoney"
                />
              </FormItem>
            </Col>
            <Col span="6">
              <FormItem label="已冲金额" prop="writeOffAmt">
                <InputNumber
                  ...
                  placeholder="已冲金额"
                  :min="0"
                  v-model="formDataInfo.master.writeOffAmt"
                />
              </FormItem>
            </Col>
            <Col span="6">
              <FormItem label="未冲金额" prop="notwriteOffAmt">
                <InputNumber
                  ...
                  placeholder="未冲金额"
                  :min="0"
                  v-model="formDataInfo.master.notwriteOffAmt"
                />
              </FormItem>
            </Col>
            <Col span="12">
