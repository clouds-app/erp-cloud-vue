      ...
      <Tabs @on-click="TabsClickEvent" :animated="false">
        <TabPane label="明细" name="detailed">
          <vTable
            ...
            :columns-url="functionParams.requestColBaseUrl + '/AccountVendInvoiceCheckInfoFm'"
            :table-data="tableBoxCoWorkProcData"
            :pagination="false"
            name="AccountVendInvoiceCheckInfoFm"
          ></vTable>
        </TabPane>
        ...
        <TabPane label="汇总" name="Summary">
          <vTable
            ...
            ref="tableFieldRef"
            :table-data="tableBoxCoWorkProcData"
            :columns-url="functionParams.requestColBaseUrl + '/AccountVendInvoiceCheckSumFm'"
            :pagination="false"
            name="AccountVendInvoiceCheckSumFm"
          ></vTable>
        </TabPane>
        <ReportPage 
            slot="extra" 
...
export default {
  ...
  data() {
    return {
      ...
      // 查询配置参数
      functionParams: {
        formInitPreName: "AccountVendInvoiceCheckInfoFm", // 查询表格列头信息 前缀 例如:boxco mainFm/itemFm/mdataFm
