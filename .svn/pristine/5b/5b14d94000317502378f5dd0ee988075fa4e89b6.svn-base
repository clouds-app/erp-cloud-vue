        ...
        >
            ...
            <Col span="6">
                <FormItem  label="退货日期" prop="brDate">
                   ...
                   transfer
                   :clearable="false"
                    :value="formDataInfo.master.brDate" 
                    type="datetime"
             ...
             <Col span="6">
                <FormItem :label-width="90" label="月结日期" prop="brMonthDate">
                   <DatePicker
                    ...
                    transfer
                    :clearable="false"
                    :value="formDataInfo.master.brMonthDate" 
                    type="datetime"
                    format="yyyy-MM-dd HH:mm:ss"
                  ></DatePicker>
                </FormItem>
...
const default_formDataInfo = {
  ...
  master: {
    // auditTime: "",
		...
		brCarNo: "",
		brCube: 0,
		brDate: new Date(dayjs().format("YYYY-MM-DD HH:mm:ss")),//退货日期,
		brFollower: 0,
		brFollowerCode: "",
		brFollowerName: "",
		brIsAcc: false,
		brMoney: 0,
		brMonthDate: new Date(dayjs().format("YYYY-MM-DD HH:mm:ss")),//月结日期
		brNo: "",
		brQty: 0,
		brReason: "",
		brTranAmount: 0,
...
export default {
  ...
  data() {
    return {
      formName: "stockboxreFm", // 重写父类 查询表单名称
        // 查询配置参数
      functionParams: {
 ...
 created() {
  ...
  methods: {
      setDefaultData(){
        this.formDataInfo.master.brDate = new Date(this.formDataInfo.master.brDate) 
        this.formDataInfo.master.brMonthDate = new Date(this.formDataInfo.master.brMonthDate) 
      },
