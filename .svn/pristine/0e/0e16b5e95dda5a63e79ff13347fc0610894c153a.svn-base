       ...
       <div id='saleOrderListBox' class="saleOrderListBox">
           ...
           <div class="saleOrderListItem upSide">
            <Form ref="formCustom" class="formCustomBox" :model="formCustom" :rules="ruleCustom" :label-width="80">
                 <FormItem class="formCustomItem" label="订单号" prop="bcNo">
                    <Input type="text" placeholder="订单号" v-model="formCustom.bcNo"></Input>
                </FormItem>
                 <FormItem class="formCustomItem" label="工单号" prop="workNo">
                    <Input type="text" placeholder="工单号" v-model="formCustom.workNo"></Input>
                </FormItem>
                ...
                <FormItem class="formCustomItem" label="状态" prop="iisClose">
