        ...
        <Row>
                ...
                <FormItem label="供应商编号" prop="supplierCode">
                  <div>
                    <popup
                      ...
                      render-fields="supplierId,supplierCode,supplierName,curyId,taxTp,taxRat,rate,coinId"
          ...
          <Col span="6">
            <FormItem label="月结" prop="isAcc">
              <Checkbox disabled v-model="formDataInfo.master.isAcc" maxlength="20" placeholder></Checkbox>
            </FormItem>
          </Col>
          <Col span="6">
