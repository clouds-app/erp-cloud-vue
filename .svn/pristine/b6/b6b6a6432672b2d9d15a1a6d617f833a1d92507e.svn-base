      ...
      <div class="edit-purPaperPoAnalyzSlave">
        <Row >
         ...
         <Col span="3">
          ...
          <Col span="5">
            <FormItem  label="业务员" prop="workCode" :label-width="60">
              <popup
          ...
          <Col span="4">
            <FormItem  label="货币" prop="coinCode" :label-width="60">
              <popup
      ...
      <Tabs @on-click="TabsClickEvent" :animated="false">
        <TabPane label="明细" name="detailed">
          <vTable
            ...
            :columns-url="functionParams.requestColBaseUrl + '/statisAccgathDetailFm'"
            :table-data="tableBoxCoWorkProcData"
            :pagination="false"
            name="statisAccgathDetailFm"
          ></vTable>
        </TabPane>
        ...
        <TabPane label="汇总" name="Summary">
          <vTable
            ...
            ref="tableFieldRef"
            :table-data="tableBoxCoWorkProcData"
            :columns-url="functionParams.requestColBaseUrl + '/statisAccgathGroupFm'"
            :pagination="false"
            name="statisAccgathGroupFm"
          ></vTable>
        </TabPane>
        <ReportPage 
            slot="extra" 
...
export default {
  ...
  data() {
    return {
      ...
      // 查询配置参数
      functionParams: {
        formInitPreName: "statisAccinvoDetailFm", // 查询表格列头信息 前缀 例如:boxco mainFm/itemFm/mdataFm
  ...
  methods: {
    ...
    getreportUrl(){
      let url = '/spGetAccCustGathStatis'
      if (this.currentTabName=="Summary") {
        url = '/spGetAccCustGathGroup'
      }
      return url
    },
    // tab 切换事件
    ...
    LoadBoxCoWorkProcData(url) {
        ...
        let params = {
            ...
            stratDateTime:!!this.formDataInfo.stratDateTime ?dayjs(this.formDataInfo.stratDateTime).format('YYYY-MM-D'):'',
  ...
  created() {
    this.LoadBoxCoWorkProcData('/spGetAccCustGathStatis');
  },
  mounted() {}
};
</script>
