    ...
    >
      <div v-if="initData.columns && showWindow">
        <Form
          ...
          :rules="ruleValidate"
          :label-width="100"
          :label-colon="$store.getters.formShowColon"
        >
          <!-- update -->
              ...
              <Row>
                ...
                <Col span="24">
                  <FormItem label="料号" prop="bpBatchNo">
                    <Input
                      :disabled="detailDisabled"
                      v-model="formDataInfo.master.bpBatchNo"
                      maxlength="80"
                      placeholder="请输入料号"
                    ></Input>
                  </FormItem>
                ...
                <Col span="24">
                  <FormItem label>
                    <Checkbox
                      :disabled="detailDisabled"
                      v-model="formDataInfo.master.bpIsDiameter"
                    >内径</Checkbox>
                    <Checkbox :disabled="detailDisabled" v-model="formDataInfo.master.iisPublic">公用</Checkbox>
                    <Checkbox
                      :disabled="detailDisabled"
                      v-model="formDataInfo.master.bpIsFullPrint"
                    >满版印刷</Checkbox>
                    <Checkbox :disabled="detailDisabled" v-model="formDataInfo.master.bpWF">外发</Checkbox>
                  </FormItem>
                </Col>
                ...
                <Col span="24">
                  <FormItem label="商检号" prop="bpShopNo">
                    <Input
                      :disabled="detailDisabled"
                      v-model="formDataInfo.master.bpShopNo"
                      maxlength="80"
                      placeholder="请输入商检号"
                    ></Input>
                  </FormItem>
              ...
              <Row>
                <Col span="24">
                  <FormItem label="客方盒式" prop="bpCBoxCode">
                    <popup
                      :disabled="detailDisabled"
                      v-model="formDataInfo.master.bpCBoxCode"
                      field-name="bpCBoxCode"
                      popup-name="BoxSingleBox"
                      :fill-model.sync="formDataInfo.master"
                      render-fields="bpCBoxId,bpCBoxCode,bpCBoxName,bpPBoxId,bpPBoxCode,bpPBoxName"
                      from-fields="id,boxCode,boxName,id,boxCode,boxName"
                      :suffix="true"
                      :suffix-model="formDataInfo.master.bpCBoxName"
                      :query-params="{}"
                    />
                  </FormItem>
                </Col>
                <Col span="12">
                  <FormItem label="客方纸质" prop="bpCArtCode">
                    <popup
                      ...
                      :fill-model.sync="formDataInfo.master"
                      render-fields="bpCArtId,bpCArtCode,bpPArtId,bpPArtCode"
                ...
                <Col span="12">
                  <FormItem label="楞别" prop="lengId">
                    <Select
                      :disabled="detailDisabled"
                      v-model="formDataInfo.master.lengId"
                      :label-in-value="true"
                      @on-change="lbCodeChangedEvent"
                    >
                      <Option
                        v-for="(item,index) in lbCodeList"
                        :key="index"
                        :value="item.lengId"
                      >{{item.lbCode}}</Option>
                    </Select>
                ...
                <Col span="24">
                  <FormItem label="生产备注" prop="bpPRemark">
                    <popup
                      ...
                      field-name="bpPRemark"
                      popup-name="ResumeSingleBox"
                      :fill-model.sync="formDataInfo.master"
                      render-fields="bpPRemark"
                ...
                <Col span="24">
                  <FormItem label="送货备注" prop="bpDRemark">
                    <popup
                      ...
                      field-name="bpDRemark"
                      popup-name="ResumeSingleBox"
                      :fill-model.sync="formDataInfo.master"
                      render-fields="bpDRemark"
                      from-fields="resumeName"
                ...
                <Col span="6">
                  <FormItem label="色数" prop="bpColorQty" class="ivu-form-item-text2">
                    <Input
                      ...
                      @mousewheel.native.prevent
                      number
                      v-model="formDataInfo.master.bpColorQty"
                      placeholder="请输入色数"
                    ></Input>
                  </FormItem>
                </Col>
                <Col span="18">
                  <FormItem label="模板" prop="bpDPNo">
                    <popup
                      @blur="calcMaterialData"
                      :disabled="detailDisabled"
                      v-model="formDataInfo.master.bpDPNo"
                      field-name="bpDPNo"
                      popup-name="DieCuttingPlateSingleBox"
                      :fill-model.sync="formDataInfo.master"
                      render-fields="bpDPNo,bpDPName,dpLength,dpWidth,dpLengthInch,dpWidthInch"
                      from-fields="dpNo,bpName,dpLengthmm,dpWidthmm,dpLengthInch,dpWidthInch"
                      :suffix="true"
                      :suffix-model="formDataInfo.master.bpDPName"
                      :query-params="{custId:formDataInfo.master.custId,boxId:formDataInfo.master.bpCBoxId}"
                      @on-fill="bpDPNoOnFillEvent"
                    />
                  </FormItem>
                </Col>
                <Col span="6">
                ...
                <Col span="15">
                  <FormItem label="印唛" prop="bpPMNo">
                    <popup
                      :disabled="detailDisabled"
                      v-model="formDataInfo.master.bpPMNo"
                      field-name="bpPMNo"
                      popup-name="PrintMarksSingleBox"
                      :fill-model.sync="formDataInfo.master"
                      render-fields="bpPMNo,bpPMName"
                      from-fields="pmNo,bpName"
                      :suffix="true"
                      :suffix-model="formDataInfo.master.bpPMName"
                ...
                <Col span="9">
                  <FormItem label="印版" prop="bpPPNo" class="ivu-form-item-text2">
                    <popup
                      :disabled="detailDisabled"
                      v-model="formDataInfo.master.bpPPNo"
                      field-name="bpPPNo"
                      popup-name="PrintSingleBox"
                      :fill-model.sync="formDataInfo.master"
                      render-fields="bpPPNo"
                      from-fields="tpNo"
                      :suffix="false"
                      :query-params="{custId:formDataInfo.master.custId}"
                    />
              ...
              <Row>
                <Col span="24">
                  <FormItem label="生产盒式" prop="bpPBoxCode">
                    <popup
                      :disabled="detailDisabled"
                      v-model="formDataInfo.master.bpPBoxCode"
                      ...
                      :suffix="true"
                      :suffix-model="formDataInfo.master.bpPBoxName"
                      :query-params="{}"
                    />
                  </FormItem>
                </Col>
                ...
                <Col span="12">
                  <!-- <FormItem label="修边" prop="bpAdjBorder">
                    <Input
                      type="number"
                      :disabled="detailDisabled"
                      @on-blur="calcBoxExpressions"
                      @mousewheel.native.prevent
                      number
                      v-model="formDataInfo.master.bpAdjBorder"
                      placeholder="请输入修边"
                    ></Input>
                  </FormItem>-->
                </Col>
                ...
                <Col span="12">
                  <FormItem label="单面积(m²)" prop="bpSArea">
                    <Input
                      type="number"
                      @mousewheel.native.prevent
                      number
                ...
                <Col span="12">
                  <FormItem label="单重(kg)" prop="bpSWeight">
                    <Input
                      type="number"
                      @mousewheel.native.prevent
                      number
                ...
                <Col span="12">
                  <FormItem label="单体积(m³)" prop="bpSCube">
                    <Input
                      type="number"
                      @mousewheel.native.prevent
                      number
                ...
                <Col span="3" style="line-height: 35px;">
                  <span>{{$params.DieCutUnit}}</span>
                </Col>
              </Row>
            </div>
          </div>
        ...
        <Tabs>
          ...
          <TabPane label="纸板规格" name="ProductMData">
            ...
            >
              <template slot="head">
                <tr
                  v-for="(columnGroup,index) in initData.columns.productMDataFm.editGroups"
                  :key="index"
                >
                  <th
                    ...
                    v-if="checkColumnsIsHidden(column.key)"
                  >
              ...
              <template slot="body" slot-scope="{ row, index, valueChangeAssign }">
                ...
                >
                  <popup
                    ...
                    render-fields="artCode,bmArtId"
                    from-fields="artCode,id"
                    :index="index"
                    :suffix="false"
                    @on-fill="subArtPopupFillEvent"
                    :init-data="initData.initData.productMDataFm"
                  />

                  <Select
                    :disabled="detailDisabled"
                    v-model="row[column.key]"
                    v-else-if="column.key == 'bmScoreType'"
                    transfer
                  >
                    <Option
                  ...
                  <Select
                    :disabled="detailDisabled"
                    v-else-if="column.key == 'bmScoreDepth'"
                    v-model="row[column.key]"
                    transfer
                  >
                    <Option
                      v-for="(item,index) in pressingLineDeepList"
                      :key="index"
                      :value="item.dicValue"
                    >{{item.dicLabel}}</Option>
                  </Select>
                  <formControl
                    :disabled="detailDisabled"
                    v-else-if="column.key == 'bmIndex'"
                    :control-type="column.controlType"
                    v-model="row[column.key]=row[column.key] == 0 ? index+1 : row[column.key]"
                  ></formControl>
                  <formControl
                    :disabled="detailDisabled"
                    v-else-if="column.key == 'bmDoubleCut'"
                    :control-type="column.controlType"
                    disabled
                    v-model="row[column.key]"
                  ></formControl>
          ...
          <TabPane label="生产工序" name="ProductWorkProc">
            ...
            >
              <template slot="head">
                <tr
                  v-for="(columnGroup,index) in initData.columns.productWorkProcFm.editGroups"
                  :key="index"
                >
                  <th
                    class="ivu-table-column-left"
