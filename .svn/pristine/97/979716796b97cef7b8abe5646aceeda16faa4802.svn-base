      ...
      <Tabs @on-click="TabsClickEvent" :animated="false">
        <TabPane label="明细" name="detailed">
          <vTable
            ...
            :columns-url="functionParams.requestColBaseUrl + '/statisAccinvoDetailFm'"
            :table-data="tableBoxCoWorkProcData"
            :pagination="false"
            name="statisAccinvoDetailFm"
          ></vTable>
        </TabPane>
        ...
        <TabPane label="汇总" name="Summary">
          <vTable
            ...
            ref="tableFieldRef"
            :table-data="tableBoxCoWorkProcData"
            :columns-url="functionParams.requestColBaseUrl + '/statisAccinvoGroupFm'"
            :pagination="false"
            name="statisAccinvoGroupFm"
          ></vTable>
        </TabPane>
        <ReportPage 
            slot="extra" 
...
export default {
  ...
  methods: {
    ...
    getreportUrl(){
      let url = '/spGetAccCustInvoStatis'
      if (this.currentTabName=="Summary") {
        url = '/spGetAccCustInvoGroup'
      }
      return url
    },
    // tab 切换事件
  ...
  created() {
    this.LoadBoxCoWorkProcData('/spGetAccCustInvoStatis');
  },
  mounted() {}
};
</script>
