      ...
      <Tabs @on-click="TabsClickEvent" :animated="false">
        <TabPane label="明细" name="detailed">
          <vTable
            ...
            :columns-url="functionParams.requestColBaseUrl + '/otherpayreportFm'"
            :table-data="tableBoxCoWorkProcData"
            :pagination="false"
            name="otherpayreportFm"
          ></vTable>
        </TabPane>
        ...
        <TabPane label="汇总" name="Summary">
          <vTable
            ...
            ref="tableFieldRef"
            :table-data="tableBoxCoWorkProcData"
            :columns-url="functionParams.requestColBaseUrl + '/otherpaySumreportFm'"
            :pagination="false"
            name="otherpaySumreportFm"
          ></vTable>
        </TabPane>
        <ReportPage 
            slot="extra" 
