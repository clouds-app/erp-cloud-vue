        ...
        <Row>
          <Col span="6">
            ...
            <!-- <FormItem label="客方纸质" prop="bpCArtId">
              <Input
                v-model="formDataInfo.master.bpCArtId"
                type="number"
                maxlength="80"
                placeholder="请输入客方纸质"
              ></Input>
             ...
             <FormItem label="客方盒式" prop="bpCBoxId">
              <Input
                v-model="formDataInfo.master.bpCBoxId"
                type="number"
                maxlength="80"
                placeholder="请输入客方盒式"
              ></Input>
             ...
             <FormItem label="颜色" prop="bpColorId">
              <Input
                v-model="formDataInfo.master.bpColorId"
                maxlength="80"
                placeholder="请输入颜色"
              ></Input>
            </FormItem>
             <FormItem label="色数" prop="bpColorQty">
              <Input
          ...
          <Col span="6">
             ...
             <FormItem label="客方产品编号" prop="bpCustProdNo">
              <Input
                v-model="formDataInfo.master.bpCustProdNo"
                maxlength="80"
                placeholder="请输入客方产品编号"
              ></Input>
            </FormItem>
             <FormItem label="客方单面积" prop="bpCustSArea">
              <Input
                v-model="formDataInfo.master.bpCustSArea"
                type="number"
                maxlength="80"
                placeholder="请输入客方单面积"
              ></Input>
            </FormItem>
             ...
             <!-- <FormItem label="客户" prop="custId">
              <Input
                v-model="formDataInfo.master.custId"
                maxlength="80"
                placeholder="请输入客户Id"
              ></Input>
            </FormItem> -->
          ...
          <Col span="6">
               ...
               <!-- <Select
                          v-model="formDataInfo.bpIsFullPrint"
                          placeholder="请选择是否" >
            ...
            <FormItem label="公用" prop="bpIsPublic">
            
               <!-- <Select
                          v-model="formDataInfo.bpIsPublic"
                          placeholder="请选择是否" >
                          <Option value="0">0否</Option>
                          <Option value="1">1是</Option>
                          
                </Select> -->
                <i-switch size="default"  v-model="formDataInfo.master.bpIsPublic">
                    <span slot="open">是</span>
                    <span slot="close">否</span>
                </i-switch>
            ...
            <FormItem label="附件" prop="attachment">
             ...
             <FormItem label="生产纸质" prop="bpPArtId">
              <Input
                v-model="formDataInfo.master.bpPArtId"
                maxlength="80"
                placeholder="请输入生产纸质"
              ></Input>
            </FormItem>
             <FormItem label="生产盒式" prop="bpPBoxId">
              <Input
                v-model="formDataInfo.master.bpPBoxId"
                maxlength="80"
                placeholder="请输入生产盒式"
              ></Input>
            </FormItem>
            ...
            <FormItem label="愣别名称" prop="lengName">
              <Input
                v-model="formDataInfo.master.lengName"
                maxlength="80"
                placeholder="请输入楞别"
              ></Input>
            </FormItem>
          ...
          <Col span="6">
            ...
            <FormItem label="单位" prop="bpUnitId">
              <Input
                v-model="formDataInfo.master.bpUnitId"
                maxlength="80"
                placeholder="请输入单位"
              ></Input>
            </FormItem>
    ...
    getCurrentSubItemlength_productMData(){
      ...
      if(this.action==='add'){
          if(tableData.addList.length>0){
            this.currentSubItemlength_productMData=Object.keys(tableData.addList[0]).length
          }
      }else{
          if(tableData.updateList.length>0){
                this.currentSubItemlength_productMData= Object.keys(tableData.updateList[0]).length
          }
          if(tableData.addList.length>0){
            this.currentSubItemlength_productMData=Object.keys(tableData.addList[0]).length
          }
       ...
       // debugger
        ...
        if(this.action==='add'){
          if (tableData2.addList.length>0) {
            this.currentSubItemlength_productWorkProc=Object.keys(tableData2.addList[0]).length
            
          }
        }else{
            if (tableData2.updateList.length>0) {
              this.currentSubItemlength_productWorkProc= Object.keys(tableData2.updateList[0]).length
            }
            if (tableData2.addList.length>0) {
            this.currentSubItemlength_productWorkProc=Object.keys(tableData2.addList[0]).length
          }
